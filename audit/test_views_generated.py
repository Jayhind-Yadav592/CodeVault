...
class AuditLogAPIDetailedTest(APITestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(email='user1_AuditLog@test.com', password='pwd')
        self.user2 = User.objects.create_user(email='user2_AuditLog@test.com', password='pwd')
        self.admin = User.objects.create_superuser(email='admin_AuditLog@test.com', password='pwd')

    def test_list_unauthenticated(self):
        url = '/api/v1/audit/auditlogs/'
