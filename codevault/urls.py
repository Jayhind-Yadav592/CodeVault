...
urlpatterns = [
    ...
    path('admin/workflows/<uuid:org_id>/', core.views.org_workflows_dashboard, name='org_workflows'),
    ...
    path('api/v1/workflows/', include('workflows.urls', namespace='workflows')),
    path('api/v1/knowledge/', include('knowledge.urls', namespace='knowledge')),
    path('api/v1/incidents/', include('incidents.urls', namespace='incidents')),
    path('api/v1/support/', include('support.urls', namespace='support')),
    path('api/v1/billing/', include('billing.urls', namespace='billing')),
    path('api/v1/storage_platform/', include('storage_platform.urls', namespace='storage_platform')),
