...
class UserAPIDetailedTest(APITestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(email='user1_User@test.com', password='pwd')
        self.user2 = User.objects.create_user(email='user2_User@test.com', password='pwd')
        self.admin = User.objects.create_superuser(email='admin_User@test.com', password='pwd')
