...
class NotificationAPIDetailedTest(APITestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(email='user1_Notification@test.com', password='pwd')
        self.user2 = User.objects.create_user(email='user2_Notification@test.com', password='pwd')
        self.admin = User.objects.create_superuser(email='admin_Notification@test.com', password='pwd')
    ...
    def test_retrieve_unauthenticated(self):
        url = '/api/v1/notifications/notifications/1/'
        response = self.client.get(url)
        self.assertIn(response.status_code, [401, 403, 404])
